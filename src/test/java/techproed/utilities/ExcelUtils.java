...
public class ExcelUtils {
    ...
    // Constructor: Excel path'ine ve sayfaya ulasmak icin kullaniriz
    public ExcelUtils(String path, String sheetName) {
        ...
        try {
            ...
            // Doluysa test gecer bossa mesaji verir
        } catch (Exception e) {
    ...
    // Excel'deki verileri Test sinifinda kullanmak icin bu methodu kullaniriz
    ...
    // Excel'de satir ve sutun sayilari girildiginde o hucredeki veriyi almaya yarar
    ...
    // ============ Excel'deki datalari iki boyutlu(2D) arary seklinde alir ==============
    ...
    // Excel'deki datalari basliksiz olarak 2 boyutlu arary seklinde return eder
