...
public class Day20_SoftAssertion {
    ...
    public void softAssertTest() {
        ...
        softAssert.assertAll(); // PASS yada FAIL olarak assertion'lari isaretler ve FAIL varsa test gecmez ve aciklamalari da yapar
        // .assertAll(); kullanilmazsa icerisinde FAIL olsa bile test gecer PASS olur
    }
}
