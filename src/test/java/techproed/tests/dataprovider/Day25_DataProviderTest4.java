...
public class Day25_DataProviderTest4 {
    ...
    // Bu ornekte Data Providere methodumuz Util class'tan gelecek


    // musteriVerileri
    @Test(dataProvider = "musteriVerileri", dataProviderClass = DataProviderUtils.class) // methodun hangi classta oldugunu burada belirtiyoruz
